...
/* USER CODE BEGIN PV */
//__attribute__((aligned(32), section(".SDRAM"))) uint32_t buf[800 * 480] = {0};
/* USER CODE END PV */
...
//    at24cxx_basic_init(AT24C02, AT24CXX_ADDRESS_A000);
    ...
    // HAL_Delay(1000);
    // tim4_set_pwm_duty(255);
    //__dma2d_fill((void *)0xD2000000, 800, 480, 0, LCD_COLOR_DARKRED,
    // LTDC_PIXEL_FORMAT_ARGB8888); HAL_Delay(1000);
    //__dma2d_fill((void *)0xD2000000, 800, 480, 0, LCD_COLOR_YELLOW,
    // LTDC_PIXEL_FORMAT_ARGB8888); HAL_Delay(1000);

    // for (int i = 0; i < 800 * 480; i++)  buf[i] = LCD_COLOR_BLUE;
    //__dma2d_copy((void *)buf, (void *)0xD2000000, 100, 480, 0, 800 - 100,
