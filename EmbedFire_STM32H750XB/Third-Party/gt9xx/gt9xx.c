...
//	/*
//		无需传送配置参数
//		GT911_WriteReg(GT911_CONFIG_REG, (uint8_t *)gt911_cfg_paras, sizeof(gt911_cfg_paras));
//	*/
//	
//	gt911_info.TimerCount = 0;
//	gt911_info.Enable = 1;
...
//    i2c_SendByte(gt911_info.i2c_addr);	/* 发送设备地址+写信号 */
//	i2c_WaitAck();
...
//		i2c_Start();
//		i2c_SendByte(gt911_info.i2c_addr + 0x01);	/* 发送设备地址+读信号 */
...
//	if (gt911_info.Enable == 0)
//	{
//		return;
//	}
//	
//	/* 20ms 执行一次 */
//	if (gt911_info.TimerCount < 10)
//	{
//		return;
//	}
...
//		
//	*/
//	gt911_info.TouchpointFlag = buf[0];
//	gt911_info.Touchkeystate = buf[1];

//	gt911_info.X0 = ((uint16_t)buf[3] << 8) + buf[2];
//	gt911_info.Y0 = ((uint16_t)buf[5] << 8) + buf[4];
//	gt911_info.P0 = ((uint16_t)buf[7] << 8) + buf[6];

//	#if 0	/* 其余4点一般不用 */
//		gt911_info.X1 = ((uint16_t)buf[9] << 8) + buf[10];
//		gt911_info.Y1 = ((uint16_t)buf[11] << 8) + buf[12];
//		gt911_info.P1 = ((uint16_t)buf[13] << 8) + buf[14];

//		gt911_info.X2 = ((uint16_t)buf[17] << 8) + buf[16];
//		gt911_info.Y2 = ((uint16_t)buf[19] << 8) + buf[18];
//		gt911_info.P2 = ((uint16_t)buf[21] << 8) + buf[20];

//		gt911_info.X3 = ((uint16_t)buf[24] << 8) + buf[23];
//		gt911_info.Y3 = ((uint16_t)buf[26] << 8) + buf[25];
//		gt911_info.P3 = ((uint16_t)buf[28] << 8) + buf[27];

//		gt911_info.X4 = ((uint16_t)buf[31] << 8) + buf[30];
//		gt911_info.Y4 = ((uint16_t)buf[33] << 8) + buf[32];
//		gt911_info.P4 = ((uint16_t)buf[35] << 8) + buf[34];
//	#endif
...
//		printf("(%5d,%5d,%3d) ",  gt911_info.X0, gt911_info.Y0, gt911_info.P0);
//		printf("(%5d,%5d,%3d) ",  gt911_info.X1, gt911_info.Y1, gt911_info.P1);
//		printf("(%5d,%5d,%3d) ",  gt911_info.X2, gt911_info.Y2, gt911_info.P2);
//		printf("(%5d,%5d,%3d) ",  gt911_info.X3, gt911_info.Y3, gt911_info.P3);
//		printf("(%5d,%5d,%3d) ",  x, y, gt911_info.P4);
//		printf("\r\n");
//	}
//#endif	
//}
